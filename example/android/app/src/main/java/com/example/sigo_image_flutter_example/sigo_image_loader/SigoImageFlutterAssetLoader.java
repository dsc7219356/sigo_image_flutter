 ...
 */
public class SigoImageFlutterAssetLoader implements SigoImageLoaderProtocol {

    private Context context;

    public SigoImageFlutterAssetLoader(Context context) {
    ...
    public void handleRequest(SigoImageRequestConfig request, SigoImageResponse response) {
        ...
        if (path == null || path.length() <= 0) {
            response.onResult(SigoImageResult.genFailRet("path 为空"));
            return;
        }
