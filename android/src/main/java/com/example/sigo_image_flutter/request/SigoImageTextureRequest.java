...
import com.example.sigo_image_flutter.loader.FlutterImage;
 ...
 */
public class SigoImageTextureRequest extends SigoImageBaseRequest {
    ...
    public SigoImageTextureRequest(Map<String, Object> arguments, TextureRegistry textureRegistry) {
        super(arguments);
    ...
    @Override
    void onLoadResult(final SigoImageResult result) {
    ...
    public boolean stopTask() {
        ...
        SigoImageDispatcher.getInstance().runOnMainThreadDelayed(runnable, 2000);
        return true;
    }
    ...
    void performDraw(final FlutterImage image) {
        SigoImageDispatcher.getInstance().runOnWorkThread(new Runnable() {
            @Override
            public void run() {
