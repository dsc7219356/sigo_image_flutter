 ...
 */
public class SigoImageRequestConfig {
    ...
    public static SigoImageRequestConfig requestConfigWithArguments(Map<String, Object> arguments) {
        ...
        SigoImageRequestConfig config = new SigoImageRequestConfig();
        config.src = src;
